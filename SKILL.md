...
4. Run `script/data_profile.py` on the uploaded CSV to infer column roles, identify candidate path/label/grouping fields, summarize schema, and write `manifest_profile.json`.
